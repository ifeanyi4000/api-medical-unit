...
import { getAllUsersService, getUserByIdC, updateUsersRoleService } from '../services/user.service';
...
export const forgotPasswordApi = async (req: Request, res: Response, next: NextFunction) => {
    try {
        const { email } = req.body;
...
export const resetPasswordApi = async (req: Request, res: Response, next: NextFunction) => {
    try {
